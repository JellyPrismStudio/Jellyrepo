...
event_inherited()
zcheck_script_bottom = collide_slope_y2_bottom
zcheck_script_top    = collide_slope_y2_top
my_tex = background_get_texture(tex_floor_zuma)
z = 0
slope = 0.5//Slope factor - if the ramp should go 64 pixels up per 64 pixels wide, this is 1
