/// @description terrain_ceil_get_z(x,y)
/// @param x
/// @param y
function terrain_ceil_get_z(argument0, argument1) {
	...
	z11 = ds_grid_get(CEILGRID,x1,y1)
	z12 = ds_grid_get(CEILGRID,x1,y2)
	z21 = ds_grid_get(CEILGRID,x2,y1)
	z22 = ds_grid_get(CEILGRID,x2,y2)
