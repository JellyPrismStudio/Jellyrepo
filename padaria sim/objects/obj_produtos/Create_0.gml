f_array = function()
{
	...
	{
		if (point_in_rectangle(device_mouse_x_to_gui(0), device_mouse_y_to_gui(0), room_width/2-250+(i-floor(i/5)*5)*100-36, 100-36+80*floor(i/5), room_width/2-250+(i-floor(i/5)*5)*100+36, 100+36+80*floor(i/5)))
		{
			draw_set_color(c_gray);
			draw_rectangle(room_width/2-250+(i-floor(i/5)*5)*100-36, 100-36+80*floor(i/5), room_width/2-250+(i-floor(i/5)*5)*100+36, 100+36+80*floor(i/5), false);
		...
		draw_sprite_ext(spr_comidas, obj.comidas[2, i], room_width/2-250+(i-floor(i/5)*5)*100, 100+80*floor(i/5), 4, 4, 0, c_white, 1);
		if (point_in_rectangle(device_mouse_x_to_gui(0), device_mouse_y_to_gui(0), room_width/2-250+i*100+45-13, 85-13+80*floor(i/5), room_width/2-250+i*100+45+13, 85+13+80*floor(i/5)))
		{
		...
		draw_sprite_ext(spr_preco, 1, room_width/2-250+(i-floor(i/5)*5)*100+45, 85+80*floor(i/5), 4, 4, 0, c_white, 1);
		shader_reset();
		if (point_in_rectangle(device_mouse_x_to_gui(0), device_mouse_y_to_gui(0), room_width/2-250+i*100+45-13, 115-13+80*floor(i/5), room_width/2-250+i*100+45+13, 115+13+80*floor(i/5)))
		{
			shader_set(shd_branco);
			if (mouse_check_button_pressed(mb_left))
			{
		...
		draw_sprite_ext(spr_preco, 0, room_width/2-250+(i-floor(i/5)*5)*100+45, 115+80*floor(i/5), 4, 4, 0, c_white, 1);
		shader_reset();
		draw_set_halign(fa_center);
		draw_text(room_width/2-250+(i-floor(i/5)*5)*100, 135+80*floor(i/5), "$" + string(obj.comidas[1, i]))
		draw_set_color(c_black);
		draw_text(room_width/2-250+(i-floor(i/5)*5)*100, 100+80*floor(i/5), string(obj.comidas[3, i]));
		draw_set_color(c_white);
		draw_set_halign(-1);
	}
}
		...
		if (point_in_rectangle(device_mouse_x_to_gui(0), device_mouse_y_to_gui(0), room_width/2-200+(i-floor(i/5)*5)*100-32, room_height-180+80*floor(i/5)-32, room_width/2-200+(i-floor(i/5)*5)*100+32, room_height-180+80*floor(i/5)+32))
		{
			...
			if (mouse_check_button_pressed(mb_left) and global.p_quantidade[i] > 0)
			{
				...
				for (var j = 0; j < array_length(obj.comidas[0]); j++;)
				{
					...
					if (j == array_length(obj.comidas[0])-1 and array_length(obj.comidas[0]) < obj.qtd_max)
					{
