function depth_objects_vertex(){
random_set_seed(0);
	//You can customize these variables, but only here - you cannot modify these elsewhere
//grass_mode = 3; //Grass mode. Explanation inside the documentation (in scripts)
...
//General variables
//grass_number = 1200; //Number of grass sprites inside the room
//grass_sprite = BushStatic; //Sprite used for the grass
...
if (grass_animate){
	...
	else if (grass_mode==3){
		var left = random_range(x, x+sprite_width);
		var top =  random_range(y, y+sprite_height);
	}
