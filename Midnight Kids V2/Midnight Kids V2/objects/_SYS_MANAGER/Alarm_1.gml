...
if global.party.players[2] != -1 check_object_and_validate(global.party.playersobj[2],global.party.playersobj[0].x,global.party.playersobj[0].y, true, "Instances");
