if instance_exists(parEvent){	
	with(parEvent){
		...
		if global.player_stats[global.player.self_index].ind == 0 {
			if super._textAll.lisa != "" super._text = super._textAll.lisa else super._text = super._textAll._default 
		}
		else if global.player_stats[global.player.self_index].ind == 1 {
			if super._textAll.ryan != "" super._text = super._textAll.ryan else super._text = super._textAll._default 
		}
		else if global.player_stats[global.player.self_index].ind == 2 {
			if super._textAll.hanna != "" super._text = super._textAll.hanna else super._text = super._textAll._default 
		}
		else if global.player_stats[global.player.self_index].ind == 3 {
			if super._textAll.dylan != "" super._text = super._textAll.dylan else super._text = super._textAll._default 
		}
		else
		{
			super._text = super._textAll._default 
		}
		...
		if super._object == "global.player" // Verifica se é relativo ao global.player. Não mudar.
		{
			scene_info[0] = [
				...
				[bubble_speech,global.player,super._text,_pnome, 1, 20, global.config.textcolor, c_olive, spr_BubbleSpeech],
