...
//show_debug_message(string(scene_indexer) + " SCENE EVENT: " + string(scene[scene_indexer]) + " TIMER: " + string(timer) + "LEN: " + string(len));
//if variable_instance_exists(self, "_sceneTimer[" + string(self.scene_indexer) +"]"){
//}


if kget_radius(self, self.sprite_width * 2, false, false, true, global.player) {
