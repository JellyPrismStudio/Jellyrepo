/// @description Drawing And Calculating Shadow
	...
	//Check visibility
	if not(instance_position(x, y, obj_uls_collider2) && obj_uls_controller2.disable_inside)
	{
		Visible = true;
	}
	else
	...
	if (Visible)
	{
		...
		for (var i = 0; i < instance_number(obj_uls_collider2); ++i) 
		{
		    ds_list_add(_list, instance_find(obj_uls_collider2, i));
		}
