...
var bg2 = instance_create_layer(object_viewport.x + 105,object_viewport.y,"Menu", bgInvDesc);

plyr = instance_create_layer(object_viewport.x,object_viewport.y+30,"Menu", menuPlayer);
