/// @description Initializing Values
	...
	//Shader Light
	uni_sh_color = shader_get_uniform( sh_lighten2, "shadow_color");
	...
	//Creating Instances
	instance_create_depth( x, y, light_depth, obj_uls_light_renderer2);
	instance_create_depth( x, y, shadow_depth, obj_uls_shadow_renderer2);
