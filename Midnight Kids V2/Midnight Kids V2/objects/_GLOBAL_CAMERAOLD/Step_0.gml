...
if camera < array_length(global.intern.enemyover)
{
	...
	sdm(global.intern.enemyover[camera], customtarget, instance_exists(oCameraAim))
}
else
{
	sdm(camera, global.intern.enemyover, customtarget, instance_exists(oCameraAim), targetobj);
}
